...
class WebExpenseControllerTest {
    ...
    void testListExpensesWithDateRange() {
        ...
        when(expenseService.getExpensesByDateRange(LocalDate.parse(startDate), LocalDate.parse(endDate)))
                .thenReturn(Arrays.asList(expense));

        String result = webController.listExpenses(startDate, endDate, model);

        assertEquals("list", result);
        verify(expenseService).getExpensesByDateRange(LocalDate.parse(startDate), LocalDate.parse(endDate));
    ...
    void testListExpensesWithoutDateRange() {
        ...
        String result = webController.listExpenses(null, null, model);
